...
public class SkeletonActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mListView.setAdapter(new ArrayAdapter<String>(this,
				R.layout.draw_list_item, mDrawerTitle));
...
//				SQLOperate.addFolder(getApplicationContext(), name);
//				SQLOperate.deleteFolder(getApplicationContext(), name);
//				break;
			case 3:
...
//		String random = "2";
//		for (int i = 0; i < 10; i++) {
//			random += (char) ((int) (Math.random() * 10) + 'a');
//		}
//		Log.d("folder", random);
//		return random;
//	}
